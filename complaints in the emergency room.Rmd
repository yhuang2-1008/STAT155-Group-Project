...
```
*More man on residency training, however, there is more man in our data
...
```
*Since the data of hours and visits are too large compare with the data for number of complaints. So we created new dataset by dividing visits and hours
...
##Intention
Without taking gender into account, will visits abnd hours affect number of complaints the doctors get.
...
#Intention
In comparison to the previous one, how gender affects the number complaints.
...
```
*41% of the variability in number of complaints is explained by the variability in number of hours worked and number of visits.

*35% of the variability in number of complaints is explained by the variability in number of hours worked, number of visits and gender.

*4.6% of the variability in number of complaints is explained by the variability in number of revenue earned and gender.
